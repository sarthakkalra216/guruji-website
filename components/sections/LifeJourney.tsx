...
const SCENES: SceneData[] = [
  {
    chapter: "01",
    era: "Origin",
    titleLine1: "A Divine Soul",
    titleLine2: "Enters the World",
    subtitle: "Nakur, Saharanpur",
    quote: "\"The soil of Nakur was chosen to receive his blessed footsteps.\"",
    description:
      "In the sacred land of Nakur, Saharanpur, a child was born whose very presence would transform thousands of lives. From his earliest years, Guruji displayed an extraordinary stillness — an inexplicable light in his eyes and a compassion that seemed ageless, as though his soul had arrived with a mission already inscribed within it.",
    icon: "🌅",
    gradient:
      "radial-gradient(ellipse 110% 90% at 50% 0%, rgba(109,40,217,0.55) 0%, rgba(4,0,12,0.97) 70%)",
    accentColor: "#a78bfa",
  ...
  },
  {
    chapter: "02",
    era: "Awakening",
    titleLine1: "The Divine Light",
    titleLine2: "Ignites Within",
    subtitle: "Spiritual Revelation",
    quote: "\"When the Guru awakens, the entire universe takes notice.\"",
    description:
      "As Guruji grew, he was drawn into deep states of meditation and prayer that would last for hours. Visions, revelations, and an unshakeable sense of divine purpose became the compass of his life. The eternal flame that burned within him began to radiate outward — and those near him could feel its warmth and transforming power.",
    icon: "🔥",
    gradient:
      "radial-gradient(ellipse 110% 90% at 50% 15%, rgba(217,119,6,0.52) 0%, rgba(4,0,12,0.97) 68%)",
    accentColor: "#fbbf24",
  ...
  },
  {
    ...
    titleLine2: "Transform Souls",
    subtitle: "The Sacred Satsangs Begin",
    quote: "\"The truth he spoke needed no translation — the heart understood.\"",
    description:
      "Guruji began to share his wisdom — first in intimate gatherings, then in satsangs that drew hundreds. His teachings were not mere philosophy; they were living truth, delivered with a warmth that bypassed the mind and spoke directly to the heart. Seva, faith, and boundless love became the three pillars of his eternal message.",
    icon: "📿",
    gradient:
      "radial-gradient(ellipse 110% 90% at 50% 15%, rgba(15,118,110,0.48) 0%, rgba(4,0,12,0.97) 68%)",
    accentColor: "#34d399",
  ...
  },
  {
    chapter: "04",
    era: "Service",
    titleLine1: "Serving the Divine",
    titleLine2: "in Every Soul",
    subtitle: "Community & Compassion",
    quote: "\"He saw the face of God in every hungry child, every weeping mother.\"",
    description:
      "Guruji established a life of selfless service — langars that fed thousands, medical camps, and shelter for the vulnerable. The ashram at Nakur became a sanctuary where no one was turned away. He taught that God is most clearly seen in the face of one who suffers — and he embodied that truth with every breath he took.",
    icon: "🙏",
    gradient:
      "radial-gradient(ellipse 110% 90% at 50% 20%, rgba(190,18,60,0.42) 0%, rgba(4,0,12,0.97) 68%)",
    accentColor: "#fb7185",
    glowColor: "rgba(190,18,60,0.33)",
  },
  {
    chapter: "05",
    era: "Presence",
    titleLine1: "A Living Shelter",
    titleLine2: "for All Seekers",
    subtitle: "Divine Grace & Protection",
    quote: "\"In his presence, even the deepest doubt dissolves and faith is reborn.\"",
    description:
      "Word of Guruji's grace spread far and wide. Devotees arrived from across India — each carrying their burdens, each leaving lighter. His darshan was not merely a meeting; it was a transformation. Through personal guidance, Guruji became the shelter that thousands had long been searching for, without knowing exactly what they sought.",
    icon: "🕊️",
    gradient:
      "radial-gradient(ellipse 110% 90% at 50% 15%, rgba(212,168,67,0.48) 0%, rgba(4,0,12,0.97) 68%)",
    accentColor: "#d4a843",
        ...
        {SCENES.map((_, i) => (
          <motion.div
            ...
            style={{
              ...
              background:
                i === active
                  ? "linear-gradient(to bottom, #f59e0b, #d4a843)"
                  : "rgba(255,255,255,0.45)",
            }}
          />
        ))}
      </div>
      {/* Horizontal — mobile bottom */}
...
function Scene({
  ...
  // Right card — comes in from right, slight delay vs title
  ...
  // Large bg chapter number (counter-parallax)
    ...
    >
      ...
      >
        <div
          ...
          style={{ background: data.glowColor, filter: "blur(100px)" }}
        />
      </motion.div>
      ...
      <div
        ...
        style={{
          background: `linear-gradient(to bottom, ${data.glowColor.replace(/[\d.]+\)$/, "0.1)")}, transparent)`,
        }}
      />

      {/* Large translucent background chapter number */}
      <motion.div
        style={{ y: numY }}
        aria-hidden
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-5 sm:px-10 lg:px-14">
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-16 items-center">
          ...
          <motion.div style={{ y: titleY, opacity: titleOp }}>
            ...
            {/* Chapter label + accent line */}
            <div className="flex items-center gap-3 mb-5 sm:mb-6">
              <span
                className="font-mono text-[10px] sm:text-xs tracking-[0.38em] uppercase font-bold"
              ...
              <div className="flex-1 h-px overflow-hidden" style={{ maxWidth: 56 }}>
                <motion.div
                  style={{ width: lineW, background: `${data.accentColor}55`, height: 1 }}
                />
              </div>
            </div>
            ...
            {/* Subtitle */}
            <p
              className="text-[10px] sm:text-xs font-semibold uppercase tracking-[0.32em]"
              style={{ color: `${data.accentColor}70` }}
            >
              {data.subtitle}
            </p>
          </motion.div>
          ...
          <motion.div style={{ x: cardX, opacity: cardOp }}>
            ...
            >
              {/* Quote */}
              <blockquote
                className="font-serif text-sm sm:text-base lg:text-lg italic leading-relaxed mb-5"
                style={{ color: data.accentColor }}
              >
                {data.quote}
              </blockquote>
              ...
              <div
                className="h-px mb-5"
                style={{
                  background: `linear-gradient(90deg, ${data.accentColor}40, transparent)`,
                }}
              />

              {/* Body text */}
              <p className="text-amber-100/62 text-sm sm:text-[0.95rem] leading-[1.88]">
                {data.description}
              </p>

              {/* Footer */}
              <div className="flex items-center justify-between mt-5 pt-4"
                style={{ borderTop: `1px solid ${data.accentColor}15` }}
              >
                <span
                  className="text-[9px] sm:text-[10px] font-mono uppercase tracking-[0.32em] opacity-35"
                  style={{ color: data.accentColor }}
                >
...
export default function LifeJourney() {
  ...
  // Header fades out as first scene comes in
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* ── Entry header (before scroll begins) ── */}
        <motion.div
        ...
        >
          <span className="text-[9px] sm:text-[10px] uppercase tracking-[0.3em] text-amber-400/45">
            Scroll to journey
          </span>
          <motion.div
            animate={{ y: [0, 7, 0] }}
            transition={{ duration: 1.5, repeat: Infinity }}
            className="text-amber-400/35 text-base"
          >
            ↓
          </motion.div>
        </motion.div>
